...
impl AccountServiceFactory {
    pub async fn build(
        ...
        generate_permission_combinations!(permission_set.read_level, permission_set.create_level, permission_set.update_level, permission_set.delete_level, connection_pool, user;
